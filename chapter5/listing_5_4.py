...
Сгенерируем список 100 случайных марок из списка час-
тых слов и вернем его в виде списка кортежей по одному значению
в каждом, чтобы его можно было сразу передать сопрограмме exe-
cutemany
'''
import asyncio
import asyncpg
...
def load_common_worlds() -> List[str]:
...
async def main():
    common_words = load_common_worlds()
