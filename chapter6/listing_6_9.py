...
from chapter6.listing_6_8 import partition, merge_dictionaries, map_frequencies
...
async def reduce(loop, pool, counters, chunk_size) -> Dict[str, int]:
    ...
    while len(chunks[0]) > 1:
        ...
        # Снова разбить результаты и выполнить ещё одну итерацию цикла
...
if __name__ == "__main__":
    asyncio.run(main(partition_size=2000000))
